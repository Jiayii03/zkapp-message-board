...
export default class ZkappWorkerClient {
  ...
  async publishMessageClient(message: string, privateKeyBase58: string) {
    return this.remoteApi.publishMessage(message, privateKeyBase58);
  }

  async getMessageClient() {
    return this.remoteApi.getMessages();
  }
